...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
  if (request.action === 'authenticate') {
    ...
    const authUrl = `https://accounts.google.com/o/oauth2/auth?client_id=815235202313-k9osdt8seskdc7e6ep1ldl4qtjs3v7oo.apps.googleusercontent.com&response_type=code&redirect_uri=${encodeURIComponent(
      redirectUri
