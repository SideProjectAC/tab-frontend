...
import { getUserInfoAPI , deleteUserAPI , updateUserAPI} from '../../api/authAPI';
...
const UserInfo = ({setShowUserInfo}) => {
  ...
  <div className='userInfoBackground'>
    <div className="userWrapper">
      ...
      <button className='userCloseButton'
        onClick={()=> setShowUserInfo(false)}>x</button>
      ...
      <div className='userButtons'>
        <button className='userButton'
          onClick={() => {
            ...
            if (showPasswordInput && newPassword && newPassword.length !== 0) handleChangePassword()
          }}
